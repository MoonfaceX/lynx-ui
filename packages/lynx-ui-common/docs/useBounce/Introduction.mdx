...
<img src={useDark() ? "/assets/threeBouncingStepsDark.png" : "/assets/threeBouncingStepsLight.png"} width="100%" />
...
<img src={useDark() ? "/assets/onScrollToBouncesLight.png" : "/assets/threeBouncingStepsLight.png"} width="100%" />
